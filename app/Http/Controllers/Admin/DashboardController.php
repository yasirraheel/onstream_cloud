...
class DashboardController extends MainAdminController
{
    ...
    public function index()
    {
            ...
            $users_last_30_days = User::where('usertype','User')->whereDate('created_at', '>=', date('Y-m-d', strtotime('-30 days')))->count();
            ...
            return view('admin.pages.dashboard',compact('page_title','users','users_today','users_last_30_days','language','genres','movies','series','sports','livetv','transactions','daily_amount','weekly_amount','monthly_amount','yearly_amount','plan_list'));
