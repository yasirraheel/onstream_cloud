      ...
      <div class="sidebar-inner slimscrollleft">
        <div id="sidebar-menu">
          ...
          <ul>
            ...
            <li><a href="{{ URL::to('admin/api_urls') }}" class="waves-effect {{classActivePath('api_urls')}}"><i class="fa fa-link"></i><span>API URLs Module</span></a></li>
            ...
            <li class="has_sub">
              ...
              <ul class="list-unstyled">
                ...
                <li class="{{classActivePath('google_derive_player')}}"><a href="{{ URL::to('admin/google_derive_player') }}" class="{{classActivePath('google_derive_player')}}"><i class="fa fa-google"></i><span>Google Drive Player</span></a></li>
