        ...
        $.ajax({
            ...
            success: function(response) {
                if (response.status === 'success' && response.data) {
                    ...
                    // Initialize Select2 with templateSelection and templateResult to support styles
                    ...
                    $('#api_file_select').html('<option value="">Failed to load files</option>');
                }
            },
            error: function() {
                $('#api_file_select').html('<option value="">Error loading files</option>');
            }
        });
    }
