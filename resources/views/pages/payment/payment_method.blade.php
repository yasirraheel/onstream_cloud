   ...
   <div class="row">
    ...
    <div class="col-lg-3 col-md-6 col-sm-6 col-xs-12">
        <div class="select-payment-method">
          ...
          <input type="hidden" name="plan_id" value="{{number_format($plan_info->id)}}">
          <input type="hidden" name="gateway_name" value="{{getPaymentGatewayInfo(4)->gateway_name}}">
          <input type="hidden" name="gateway_info" value="{{getPaymentGatewayInfo(4)->gateway_info}}">
